...
<p> An exploratory analysis of the iris data can be found in my earlier post </p> [Supervised Machine Learning - Iris data](?_posts/2017-10-29-iris-supervised.md)
